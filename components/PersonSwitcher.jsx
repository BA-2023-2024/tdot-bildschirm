...
export default function PersonSwitcher({ data }) {
  ...
  return (
    <div className="card p-0 mt-5 h-full">
      <div className="w-full h-full flex flex-col justify-between items-center text-center">
        {currentPerson && (
          <div className="flex flex-col text-center mx-auto justify-center h-full mt-6">
            <div className="h-[26rem] w-[26rem] object-cover relative">
              {data.map((person, index) => (
                <img
                  ...
                  className={`absolute top-0 left-0 h-[26rem] w-[26rem] rounded-2xl object-cover transition-all duration-500 ease-in-out ${
